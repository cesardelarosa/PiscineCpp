...
Fixed::Fixed(const int n) { this->value = n << nFractBits; }

Fixed::Fixed(const float f) { this->value = roundf(f * (1 << nFractBits)); }
...
int Fixed::toInt() const { return this->value >> nFractBits; }
