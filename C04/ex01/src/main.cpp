...
int main()
{
    ...
    wcat->makeSound(); //will output WrongAnimal sound because makeSound is not virtual

    delete meta;
    delete wcat; //potential memory leak because WrongAnimal destructor is not virtual
